<template>
  <div class="hello" v-if="ready" @keyup.enter="userLogin">
    ...
    <div class="login_container">
      ...
      <div class="afterLine">
        <input v-if="type" type="password" name="password" class="input_password" v-model="passwordVal"
               placeholder="密码"/>
      ...
      <a href="javascript:;"
         :class="{btn_next:true,btn_submit:true,btn_next_ok:usernameVal.length >=6 && passwordVal.length >=6 && namePattern.test(usernameVal)}"
